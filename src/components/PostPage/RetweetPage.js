         ...
         <div className="retweet__body" >
             <div className="retweet__header">
                 <div className="retweet__HeaderText">
                     <h3>{retweeterProfile.displayName}{' '}
                         <span className='retweet__headerSpacial'>
                         {retweeterProfile.verified && <VerifiedUserIcon className='retweet__badge'/>} 
                             @{`${retweeterProfile.username}`}
                         </span>
                         
                         <div className="retweet__headerDescription" >
                     <p>{post.retweettext}</p>
         ...
         <FooterIcon Icon={ChatBubbleOutlineIcon} onClick={()=>setIsOpenModal(true)} value={comments.length} />
                  <FooterIcon Icon={RepeatIcon} value={post.retweets} onClick={()=>setOpenModal(true)}/>
                    ...
                    <Like likes={likes}
                        ...
                        likeAction = {()=>like(postId, user.id,retweeterId)} />
